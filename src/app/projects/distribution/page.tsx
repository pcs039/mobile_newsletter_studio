      ...
      <div className="grid min-h-screen lg:grid-cols-[280px_minmax(0,1fr)]">
        <aside className="bg-[#071f46] px-6 py-7 text-white">
          <div className="mb-9">
            ...
            <p className="mt-3 text-sm leading-6 text-slate-300 [word-break:keep-all]">공개 URL과 QR을 관리합니다.</p>
          </div>
          ...
          <div className="mt-10 rounded-lg border border-white/15 bg-white/8 p-4">
            ...
            <p className="mt-2 text-xs leading-5 text-slate-300 [word-break:keep-all]">발행 완료 프로젝트 중심</p>
          </div>
        </aside>
        ...
        <section className="min-w-0 px-5 py-6 sm:px-8 lg:px-10">
          <header className="mb-7 flex flex-col gap-4 rounded-lg border border-slate-200 bg-white px-5 py-5 shadow-sm sm:flex-row sm:items-center sm:justify-between">
            <div>
              ...
              <p className="mt-2 text-sm leading-6 text-slate-500 [word-break:keep-all]">공개 링크, QR, 접속 현황을 확인합니다.</p>
            </div>
          ...
          <section className="rounded-lg border border-slate-200 bg-white shadow-sm">
            <div className="flex flex-col gap-3 border-b border-slate-200 px-5 py-4 lg:flex-row lg:items-center lg:justify-between">
              <div>
                ...
                <p className="mt-1 text-sm leading-6 text-slate-500 [word-break:keep-all]">발행 완료 프로젝트만 표시합니다.</p>
              </div>
            ...
            <div className="divide-y divide-slate-200">
              {publishedProjects.length === 0 && (
                <div className="px-5 py-12 text-center">
                  ...
                  <p className="mt-2 text-sm leading-6 text-slate-500 [word-break:keep-all]">발행 완료 처리 후 표시됩니다.</p>
                  <Link
                    href="/projects/publish"
                      ...
                      <div className="min-w-0">
                        ...
                        <div className="mt-4 grid gap-3 lg:grid-cols-[150px_150px_minmax(0,1fr)]">
                          ...
                          <div className="min-w-0 rounded-lg border border-slate-200 bg-[#f8fbff] px-4 py-3">
                            ...
                            <p className="mt-2 text-xs leading-5 text-slate-500 [word-break:keep-all]">발행 상세에서 보완 가능</p>
                          </div>
                        </div>
          ...
          {waitingProjects.length > 0 && (
            <section className="mt-7 rounded-lg border border-slate-200 bg-white shadow-sm">
              <div className="border-b border-slate-200 px-5 py-4">
                ...
                <p className="mt-1 text-sm leading-6 text-slate-500 [word-break:keep-all]">발행 전 프로젝트입니다.</p>
              </div>
              <div className="divide-y divide-slate-200">
